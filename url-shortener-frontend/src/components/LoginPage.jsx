...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex justify-center items-center px-4 py-8 relative overflow-hidden">
      <div className="absolute -top-14 -left-10 w-56 h-56 rounded-full bg-blue-500/25 blur-3xl animate-floatSlow" />
      <div className="absolute -bottom-16 -right-8 w-56 h-56 rounded-full bg-purple-500/25 blur-3xl animate-floatSlow" />
      ...
      <Motion.form
        ...
        className="sm:w-[460px] w-full max-w-[460px] glass-card p-6 sm:p-8 ring-1 ring-blue-300/30"
      >
        ...
        <p className="text-center text-slate-300 text-sm mt-1">
          Secure access to your URL intelligence workspace.
        </p>
